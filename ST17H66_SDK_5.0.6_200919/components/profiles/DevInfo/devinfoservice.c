...
/*********************************************************************
 * MACROS
 *	@brief	Choose the decive informinatino service
 *			DO NOT DISABLE all service(if you want, disable the whole 
 *			service in the ble_init)
 */
...
static uint8 devInfoPnpId[DEVINFO_PNP_ID_LEN] =
{
	...
	LO_UINT16(0x0504), HI_UINT16(0x0504),   // Vendor ID  
