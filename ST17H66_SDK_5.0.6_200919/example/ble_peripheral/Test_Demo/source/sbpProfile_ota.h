...
#define SIMPLEPROFILE_SERV_UUID               0xFFB0
    
// Key Pressed UUID
#define SIMPLEPROFILE_CHAR1_UUID            0xFFB1
#define SIMPLEPROFILE_CHAR2_UUID            0xFFB2
#define SIMPLEPROFILE_CHAR3_UUID            0xFFB3
#define SIMPLEPROFILE_CHAR4_UUID            0xFFB4
#define SIMPLEPROFILE_CHAR5_UUID            0xFFB5
#define SIMPLEPROFILE_CHAR6_UUID            0xFFB6
#define SIMPLEPROFILE_CHAR7_UUID            0xFFB7
