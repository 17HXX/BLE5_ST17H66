 ...
 */
  ...
  /*
   * linkDB_State - Check to see if a link is in a specific state.
   * 
  ...
  /*
   * linkDB_Authen - Check to see if the link is encrypted and authenticated.
  ...
  /*
   * linkDB_Up - Check to see if a link is up (connected).
  ...
  /*
   * linkDB_Encrypted - Check to see if the link is encrypted.
  ...
  /*
   * linkDB_Bonded - Check to see if the link is bonded.
