...
#define GAP_PROFILE_PERIPHERAL    0x04 //!< A device that accepts the establishment of an LE link using the connection establishment procedure
#define GAP_PROFILE_CENTRAL       0x08 //!< A device that supports the Central role initiates the establishment of a connection
