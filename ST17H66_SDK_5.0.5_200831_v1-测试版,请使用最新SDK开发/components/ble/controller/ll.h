 ...
 *
 * @brief       This function is used to initiate a BLE level Transmit Test
 ...
 *
 * @brief       This function is used to initiate a BLE level Receive Test
 ...
 *			data_chan_idx:	the index of data channel on which the data channel PDU has received
 *			rssi		:	rssi of the packet , units 0.1 dBm
