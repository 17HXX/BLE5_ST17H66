...
#define NEGEDGE             POL_FALLING       //下降沿
#define POSEDGE             POL_RISING        //上升沿
#define IO_Wakeup_Pol_e     gpio_polarity_e

#define FLOATING            GPIO_FLOATING    //浮空
#define WEAK_PULL_UP        GPIO_PULL_UP     //上拉150k
#define STRONG_PULL_UP      GPIO_PULL_UP_S   //上拉10k
#define PULL_DOWN           GPIO_PULL_DOWN   //下拉100k
